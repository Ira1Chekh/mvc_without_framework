...
<div id="wrapper">
	...
	<div id="page">
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
					<?php foreach ($newsAuthor as $newsItem):?>
					<div class="post">
						<h2 class="title"><a href='/news/<?php echo $newsItem['id'] ;?>'><?php echo $newsItem['title'].' # '.$newsItem['id'];?></a></h2>
						<p class="meta">Posted by <a href='/news/<?php echo $newsItem['author_name'] ;?>'><?php echo $newsItem['author_name']?></a> on <?php echo $newsItem['newsDate'];?>
							&nbsp;&bull;&nbsp; <a href='/news/<?php echo $newsItem['author_name'] ;?>' class="permalink"> Author article</a></p>
						<div class="entry">
